...
import img43 from '../assets/B43.png'
...
const Homeloan = () => {
  ...
  <section className='section-2'>
        <div className="section2-info">
          <h2>Home Loan</h2>
         <p><Link to={'/home'} className='text-light text-decoration-none'>Home</Link> <i className='fas fa-angle-right text-success-right'> Home Loan</i></p>
        </div>
        <img src={img32} id='b10' />
   </section>
    <section className='section-12'>
            <div className="acc12-img">
              <img src={img43} alt="img1" />
            </div>
            <div className="account12">
               <p className=' text-success'>Ready To Own Home?</p>
              ...
              <p><i className='fas fa-check text-success'></i> Competitive Rates</p>
              <Link to="/home_loan">
